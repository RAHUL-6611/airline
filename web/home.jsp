...
<!--  <body style="background: rgb(74,66,204);
background: radial-gradient(circle, rgba(74,66,204,1) 0%, rgba(124,16,148,1) 100%, rgba(0,212,255,1) 100%);height:100%; min-height:100%;margin:0;padding:0;" >-->

<body style="background-color: whitesmoke;height:100%; min-height:100%;margin:0;padding:0;" >

  
	<header>
	<!--Navigation Bar-->
    <nav class="navbar navbar-expand-md  font-weight-bold nav justify-content-center nav-justified" style="background-color: whitesmoke;color: black;">
      <a class="navbar-brand" href="home.jsp">
          <img src="./assets/img/logo.png" style="height:3em;" alt="Airlines Logo">
   ...
   <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-pause="false" style="border-bottom:3px solid black; margin-bottom:1px;">
	...
	<div class="carousel-inner">
		<div class="carousel-item active">
			<img class="d-block" src="./assets/img/banner/1.jpg" alt="First slide">
			<div class="carousel-caption d-md-block text-top">
				<h1>Welcome to  Airlines System!</h1>
			</div>
		</div>
		
		<div class="carousel-item">
			<img class="d-block img-fluid" src="./assets/img/banner/2.jpg" alt="Second slide">
		...
		<div class="carousel-item">
			<img class="d-block img-fluid" src="./assets/img/banner/3.jpg" alt="Third slide">
			<div class="carousel-caption d-md-block">
				<h1>Awarded the best European Airlines for 2011-16!</h1>
			</div>
		</div>
            <div class="carousel-item">
			<img class="d-block img-fluid" src="./assets/img/banner/4.jpg" alt="Third slide">
			<div class="carousel-caption d-md-block">
				<h1>Awarded To be No 1 in world</h1>
			</div>
		</div>
	</div>
